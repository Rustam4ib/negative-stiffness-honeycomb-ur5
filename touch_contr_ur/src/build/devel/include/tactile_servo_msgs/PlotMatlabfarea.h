// Generated by gencpp from file tactile_servo_msgs/PlotMatlabfarea.msg
// DO NOT EDIT!


#ifndef TACTILE_SERVO_MSGS_MESSAGE_PLOTMATLABFAREA_H
#define TACTILE_SERVO_MSGS_MESSAGE_PLOTMATLABFAREA_H
...
struct PlotMatlabfarea_
{
  typedef PlotMatlabfarea_<ContainerAllocator> Type;
  ...
  PlotMatlabfarea_(const ContainerAllocator& _alloc)
    : header(_alloc)
    , fx(0.0)
    , fy(0.0)
    , fz(0.0)
  ...
  typedef boost::shared_ptr< ::tactile_servo_msgs::PlotMatlabfarea_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::tactile_servo_msgs::PlotMatlabfarea_<ContainerAllocator> const> ConstPtr;

}; // struct PlotMatlabfarea_

typedef ::tactile_servo_msgs::PlotMatlabfarea_<std::allocator<void> > PlotMatlabfarea;

typedef boost::shared_ptr< ::tactile_servo_msgs::PlotMatlabfarea > PlotMatlabfareaPtr;
typedef boost::shared_ptr< ::tactile_servo_msgs::PlotMatlabfarea const> PlotMatlabfareaConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::tactile_servo_msgs::PlotMatlabfarea_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::tactile_servo_msgs::PlotMatlabfarea_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::tactile_servo_msgs::PlotMatlabfarea_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::tactile_servo_msgs::PlotMatlabfarea_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::tactile_servo_msgs::PlotMatlabfarea_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::tactile_servo_msgs::PlotMatlabfarea_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::tactile_servo_msgs::PlotMatlabfarea_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::tactile_servo_msgs::PlotMatlabfarea_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::tactile_servo_msgs::PlotMatlabfarea_<ContainerAllocator> >
{
  ...
  static const char* value(const ::tactile_servo_msgs::PlotMatlabfarea_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xb57380546f3f2858ULL;
  static const uint64_t static_value2 = 0x44e4524ecda29892ULL;
};

template<class ContainerAllocator>
struct DataType< ::tactile_servo_msgs::PlotMatlabfarea_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::tactile_servo_msgs::PlotMatlabfarea_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::tactile_servo_msgs::PlotMatlabfarea_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::tactile_servo_msgs::PlotMatlabfarea_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::tactile_servo_msgs::PlotMatlabfarea_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // TACTILE_SERVO_MSGS_MESSAGE_PLOTMATLABFAREA_H
