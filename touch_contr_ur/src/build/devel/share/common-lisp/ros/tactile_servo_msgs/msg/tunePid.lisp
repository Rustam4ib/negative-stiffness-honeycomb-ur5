...
(cl:defclass <tunePid> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass tunePid (<tunePid>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <tunePid>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'tunePid)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tactile_servo_msgs-msg:<tunePid> is deprecated: use tactile_servo_msgs-msg:tunePid instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <tunePid>))
...
(cl:defmethod err_in-val ((m <tunePid>))
...
(cl:defmethod err_out-val ((m <tunePid>))
...
(cl:defmethod dt-val ((m <tunePid>))
  ...
  (dt m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <tunePid>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <tunePid>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<tunePid>)))
  "Returns string type for a message object of type '<tunePid>"
  "tactile_servo_msgs/tunePid")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'tunePid)))
  "Returns string type for a message object of type 'tunePid"
  "tactile_servo_msgs/tunePid")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<tunePid>)))
  "Returns md5sum for a message object of type '<tunePid>"
  "d466e8971fee54af10a1ce5a1fa444c0")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'tunePid)))
  "Returns md5sum for a message object of type 'tunePid"
  "d466e8971fee54af10a1ce5a1fa444c0")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<tunePid>)))
  "Returns full string definition for message of type '<tunePid>"
  (cl:format cl:nil "Header header~%float64 err_in~%float64 err_out~%float64 dt~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'tunePid)))
  "Returns full string definition for message of type 'tunePid"
  (cl:format cl:nil "Header header~%float64 err_in~%float64 err_out~%float64 dt~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <tunePid>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <tunePid>))
