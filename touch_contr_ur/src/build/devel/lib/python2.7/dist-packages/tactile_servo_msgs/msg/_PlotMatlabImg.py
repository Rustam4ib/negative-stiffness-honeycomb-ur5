...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.joint_efforts))
      _x = self
      buff.write(_struct_45d.pack(_x.x_c1, _x.y_c1, _x.z_c1, _x.x_c2, _x.y_c2, _x.z_c2, _x.x_c3, _x.y_c3, _x.z_c3, _x.x_c4, _x.y_c4, _x.z_c4, _x.x_c5, _x.y_c5, _x.z_c5, _x.x_c6, _x.y_c6, _x.z_c6, _x.x_c7, _x.y_c7, _x.z_c7, _x.x_c8, _x.y_c8, _x.z_c8, _x.x_c9, _x.y_c9, _x.z_c9, _x.x_c10, _x.y_c10, _x.z_c10, _x.x_c11, _x.y_c11, _x.z_c11, _x.x_c12, _x.y_c12, _x.z_c12, _x.x_c13, _x.y_c13, _x.z_c13, _x.x_c14, _x.y_c14, _x.z_c14, _x.x_c15, _x.y_c15, _x.z_c15))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.fx, _x.fy, _x.fz, _x.fwx, _x.fwy, _x.fwz, _x.coc_x, _x.coc_y, _x.f, _x.zmp_x, _x.zmp_y, _x.orient_z, _x.cop_x, _x.cop_y, _x.coc_xd, _x.coc_yd, _x.fd, _x.zmp_xd, _x.zmp_yd, _x.orient_zd, _x.cop_xd, _x.cop_yd, _x.num_contours, _x.x_now, _x.y_now, _x.z_now, _x.wx_now, _x.wy_now, _x.wz_now, _x.ww_now, _x.x_des, _x.y_des, _x.z_des, _x.wx_des, _x.wy_des, _x.wz_des, _x.ww_des, _x.x_c, _x.y_c, _x.z_c, _x.dt, _x.time, _x.test_time2,) = _struct_22di20d.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.img = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 29
      (_x.is_in_contact_ur, _x.pixels_in_contact_ur, _x.highest_force_cell_ur, _x.real_total_force_ur, _x.current_state_ur,) = _struct_Bi3d.unpack(str[start:end])
