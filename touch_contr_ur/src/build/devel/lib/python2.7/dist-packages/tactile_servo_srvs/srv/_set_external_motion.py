...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_6d.pack(_x.delta_x, _x.delta_y, _x.delta_z, _x.delta_wx, _x.delta_wy, _x.delta_wz))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.delta_x, _x.delta_y, _x.delta_z, _x.delta_wx, _x.delta_wy, _x.delta_wz,) = _struct_6d.unpack(str[start:end])
      return self
