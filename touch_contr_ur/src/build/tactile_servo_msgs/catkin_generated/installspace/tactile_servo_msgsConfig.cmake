...
if("FALSE" STREQUAL "TRUE")
  set(tactile_servo_msgs_SOURCE_PREFIX /home/zhan/ros/touch_contr_ur/src/tactile_servo_msgs)
  set(tactile_servo_msgs_DEVEL_PREFIX /home/zhan/ros/touch_contr_ur/src/build/devel)
  ...
  set(tactile_servo_msgs_INSTALL_PREFIX /usr/local)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'tactile_servo_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Shadow Robot's software team <software@shadowrobot.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'tactile_servo_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  Ask the maintainer 'Shadow Robot's software team <software@shadowrobot.com>' to fix it.")
    endif()
...
set(tactile_servo_msgs_EXPORTED_TARGETS "tactile_servo_msgs_generate_messages_cpp;tactile_servo_msgs_generate_messages_lisp;tactile_servo_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${tactile_servo_msgs_dep}_FOUND)
      find_package(${tactile_servo_msgs_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${tactile_servo_msgs_dep} REQUIRED ${depend_list})
  endif()
