...

{
	...
	bag.open("/home/rustam/catkin_ws/src/experiments/src/new setup/vel control/test_github.bag", rosbag::bagmode::Write);
	...
	{	
		...
		for (int n = 0; n < 2000; n++){
			...
			bag.write("test_github", ros::Time::now(), vel_control_msg);
